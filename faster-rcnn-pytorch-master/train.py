...
def fit_ont_epoch(net,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    torch.save(model.state_dict(), 'logs/weight.pth')
...
'''
    ...
    if True:
        ...
        train_dataset   = FRCNNDataset(lines[:num_train], (input_shape[0], input_shape[1]), is_train=True,transform=train_transformer)

        val_dataset     = FRCNNDataset(lines[num_train:], (input_shape[0], input_shape[1]), is_train=False,transform=train_transformer)
